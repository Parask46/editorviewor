...
const libraryCategories = {
  "Basic Elements": [
    { icon: "heading", label: "Title", html: `<h1 style="font-size: 48px; color: #000000; margin: 0; font-weight: 700;">Heading</h1>` },
    ...
    { icon: "video", label: "Video", html: `<div style="width: 320px; height: 180px; background: #1a1a1a; display: flex; align-items: center; justify-content: center; border-radius: 8px; color: #ffffff; font-weight: 600;"><i data-lucide="play-circle" style="width:48px;height:48px;opacity:0.8;"></i></div>` },
    { icon: "mouse-pointer-2", label: "Button", html: `<button style="background: #2563eb; color: #ffffff; border: none; padding: 12px 24px; border-radius: 6px; font-weight: 600; cursor: pointer;">Click Me</button>` }
  ],
  "Layout & Structure": [
    { icon: "box", label: "Container", html: `<div style="background:#ffffff; padding:20px; border:1px solid #ddd; border-radius:8px; width: 250px; height: 150px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);"></div>` },
    { icon: "columns", label: "2 Columns", html: `<div style="display: flex; gap: 20px; width: 100%; padding: 20px; background: #f9f9f9; box-sizing: border-box;"><div style="flex: 1; background: #ffffff; padding: 20px; border: 1px dashed #ccc;">Column 1</div><div style="flex: 1; background: #ffffff; padding: 20px; border: 1px dashed #ccc;">Column 2</div></div>` },
